<%-- 
    Document   : addbook
    Created on : Oct 30, 2014, 3:09:07 PM
    Author     : Amruth
--%>
...
<head>
    <script type="text/javascript">
        function validate(){
				...
				var fname=document.myform.bcost.value;
				...
				if(mobile.length<3)
				{
					alert("Your Book Cost should Be Proper.....");
...
<center><img src="home_delivery_reach1.jpg"  style="background-position:bottom;"/></center>
<marquee>
