<%-- 
    ...
    Created on : Oct 29, 2014, 9:16:07 PM
    Author     : Amruth
--%>
...
<% 
    ...
    String u=request.getParameter("message");
    String p=request.getParameter("message1");         
    ...
    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/book","root","");
                   ...
                   String sql="insert into feedback values('"+u+"','"+p+"')";
